...
def send_start(bot, update):
    ...
    text = "Hey there! My name is MissRia - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "Join [MissRia Group](https://t.me/MissRiaGroup) if you need any support or help\n\n\
Follow [MissRia](https://t.me/MissRia_Channel) if you want to keep up with the news, updates and bot downtime!\n\n\
Made with love by @Unknown_hacker_x5\n\nWant to add me to your group? [Click here!](t.me/MissRia_Bot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="📢 Support Group", url="https://t.me/MissRia_Group")]]
